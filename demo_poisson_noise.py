...
if __name__ == '__main__':
    for peak in [128, 256, 512, 1024]:
        for n_ker in range(1, 9):
            model_name = 'exp_poisson/peak_%d/kernel_%d/Set12/1-7' % (peak, n_ker)
            args = Config(model_name, is_poisson=True, peak=peak, is_noise_blind=True)
